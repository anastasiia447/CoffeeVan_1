...
public class AppGUI extends Frame {
    ...
    public AppGUI(Application app) {
        ...
        /* REFRESH */
        refreshButton.addActionListener(l -> refreshLists());
    ...
    private ArrayList<Coffee> getCoffees() {
